...
local garages = {
    {name="Garage", colour=3, id=524, x=-1452.74, y=-508.38, z=31.58, h=0.0},
    {name="Garage", colour=3, id=524, x=-334.685, y=289.773, z=85.79, h=0.0},
    {name="Garage", colour=3, id=524, x=-55.272, y=-1838.71, z=26.56, h=0.0},
    {name="Garage", colour=3, id=524, x=126.434, y=6610.04, z=31.850, h=0.0},
    {name="Garage", colour=3, id=524, x=-791.57, y=330.28, z=85.70, h=0.0},
	{name="Garage", colour=3, id=524, x=384.49, y=-740.56, z=29.29, h=0.0},
	{name="Garage", colour=3, id=524, x=969.02, y=-1816.08, z=31.09, h=0.0},
	{name="Garage", colour=3, id=524, x=1691.77, y=3284.78, z=41.15, h=0.0},
	{name="Garage", colour=3, id=524, x=1668.48, y=4972.24, z=42.27, h=0.0},
    {name="Garage", colour=3, id=524, x=-2533.37, y=2345.90, z=33.06, h=0.0},
	{name="Garage", colour=3, id=524, x=-456.95, y=-1713.22, z=18.64, h=0.0},
	{name="Garage", colour=3, id=524, x=1189.27, y=-3105.50, z=5.67, h=0.0}
	}
...
lang_string = {
menu1 = "Ranger un vehicule",
menu2 = "Prendre un vehicule",
menu3 = "Quitter",
menu4 = "Vehicules",
menu5 = "Options",
menu6 = "Prendre",
menu7 = "Retour",
menu8 = "~y~Fleche droite~s~ ~w~pour ouvrir le menu",
menu9 = "Vendre",
menu10 = "~g~Fleche~s~ pour vendre le vehicule à 50% du prix d'achat",
menu11 = "Mise à jour vehicule",
menu12 = "Suivant",
state1 = "Sortir",
state2 = "Entrer",
text1 = "The area is crowded",
text2 = "Le vehicule n'est pas dans le garage",
text3 = "Vehicule sorti",
text4 = "Ce n'est pas ton vehicule",
text5 = "Vehicule rangé",
text6 = "Pas de vehicule",
text7 = "Vehicle vendu",
text8 = "Vehicule acquis, amuse toi bien!",
text9 = "Pas assez de tune",
text10 = "Vehicle mis à jour"
}
--[[Functions]]--
...
function vRPgt.spawnGarageVehicle(vtype, name, vehicle_plate, vehicle_colorprimary, vehicle_colorsecondary, vehicle_pearlescentcolor, vehicle_wheelcolor, vehicle_plateindex, vehicle_neoncolor1, vehicle_neoncolor2, vehicle_neoncolor3, vehicle_windowtint, vehicle_wheeltype, vehicle_mods0, vehicle_mods1, vehicle_mods2, vehicle_mods3, vehicle_mods4, vehicle_mods5, vehicle_mods6, vehicle_mods7, vehicle_mods8, vehicle_mods9, vehicle_mods10, vehicle_mods11, vehicle_mods12, vehicle_mods13, vehicle_mods14, vehicle_mods15, vehicle_mods16, vehicle_turbo, vehicle_tiresmoke, vehicle_xenon, vehicle_mods23, vehicle_mods24, vehicle_neon0, vehicle_neon1, vehicle_neon2, vehicle_neon3, vehicle_bulletproof, vehicle_smokecolor1, vehicle_smokecolor2, vehicle_smokecolor3, vehicle_modvariation) -- vtype is the vehicle type (one vehicle per type allowed at the same time)
  ...
  if vehicle == nil then
    ...
    if HasModelLoaded(mhash) then
	  ...
	  carblip = AddBlipForEntity(nveh)
	  SetBlipSprite(carblip,225)
	  SetBlipColour(carblip,4)
	  SetBlipDisplay(carblip,3)
	  SetBlipSprite(blip,530)
	  BeginTextCommandSetBlipName("STRING")
	  AddTextComponentString("Véhicule joueur")
...
function vRPgt.despawnGarageVehicle(vtype,max_range)
  ...
  if vehicle then
    ...
    if GetDistanceBetweenCoords(x,y,z,px,py,pz,true) < max_range then -- check distance with the vehicule
      ...
      Citizen.InvokeNative(0xEA386986E786A54F, Citizen.PointerValueIntInitialized(vehicle[3]))
	  TriggerEvent("vrp_garages:setVehicle", vtype, nil)
      vRP.notify({"~g~Vehicule rangé."})
    else
      vRP.notify({"~r~Trop loin du vehicule."})
    end
  else
  vRP.notify({"~r~Seulement un vehicule sorti à la fois."})
  end
end
...
function DrawText3D(x,y,z, text, scl) 
   ...
   -- if onScreen then
        ...
        SetTextColour(0, 155, 255, 255)
        SetTextDropshadow(1, 1, 1, 1, 50)
...
Citizen.CreateThread(function()
  while true do
    ...
    for _, garage in pairs(garages) do
      DrawMarker(1, garage.x, garage.y, garage.z-1, 0, 0, 0, 0, 0, 0, 3.001, 3.0001, 0.5001, 0, 155, 255, 200, 0, 0, 0, 0)
      DrawMarker(36, garage.x, garage.y, garage.z-0.2, 0, 0, 0, 0, 0, 0, 3.001, 3.0001, 1.5001, 0, 155, 255, 200, 0, 1, 0, 0)

	 
	 if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 20 then
	     DrawText3D(garage.x, garage.y, garage.z+0.9, "Garage",4.0 )
	 end
	 ...
	 if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 and IsPedInAnyVehicle(LocalPed(), true) == false then
		...
		DrawText3D(garage.x, garage.y, garage.z+1.10, lang_string.menu8,2.0 )
