...
local lsc = {
	...
	,["primarymetallic"] = { 
		...
		["secondarymetallic"] = { 
			...
			buttons = { 
				...
				{name = "Torino Red",costs = 500, colorindex = 28, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Formula Red",costs = 500, colorindex = 29, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lava Red",costs = 500, colorindex = 1500, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Blaze Red",costs = 500, colorindex = 30, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Grace Red",costs = 500, colorindex = 31, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Garnet Red",costs = 500, colorindex = 32, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sunset Red",costs = 500, colorindex = 33, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Dew Yellow",costs = 500, colorindex = 91, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Dark Green",costs = 500, colorindex = 49, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Racing Green",costs = 500, colorindex = 500, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sea Green",costs = 500, colorindex = 51, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Olive Green",costs = 500, colorindex = 52, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bright Green",costs = 500, colorindex = 53, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Gasoline Green",costs = 500, colorindex = 54, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["primarymatte"] = { 
			...
			["primarymetal"] = { 
				...
				name = "primarymetal",
				buttons = { 
					{name = "Brushed Steel",colorindex = 600,costs = 100, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Brushed Black Steel",colorindex = 118,costs = 600, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Brushed Aluminum",colorindex = 119,costs = 600, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["windows"] = { 
			...
			name = "windows",
			buttons = { 
				{name = "None",tint = false, costs = 50, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pure Black",tint = 1, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Darksmoke",tint = 2, costs = 13000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lightsmoke",tint = 3, costs = 12000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Limo",tint = 4, costs = 13000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Green",tint = 5, costs = 10500, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheelaccessories"] = { 
			...
			buttons = { 
				{name = "Stock Tires", costs = 150, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Custom Tires", costs = 400, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bulletproof Tires", costs = 35000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "White Tire Smoke", color = {254,254,254}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Black Tire Smoke", color = {1,1,1}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Blue Tire Smoke", color = {0,150,255}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Yellow Tire Smoke", color = {255,255,50}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Orange Tire Smoke", color = {255,153,51}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Red Tire Smoke", color = {255,10,10}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Green Tire Smoke", color = {10,255,10}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Purple Tire Smoke", color = {153,10,153}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pink Tire Smoke", color = {255,102,178}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Gray Tire Smoke", color = {128,128,128}, costs = 450, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["respray"] = { 
			title = "resprays", 
		...
		["primarychrome"] = { 
			...
			buttons = { 
				{name = "Chrome", costs = 500, colorindex = 120, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["secondarychrome"] = { 
			title = "secondary colors", 
		...
		["secondaryclassic"] = { 
			...
			name = "suspensions",
			buttons = { 
				{name = "Stock Suspension",mod = -1,modtype =15, costs = 300, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lowered Suspension",mod = false,modtype =15, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Suspension",mod = 1,modtype =15, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sport Suspension",mod = 2,modtype =15, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Competition Suspension",mod = 3,modtype =15, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = { 
			title = "transmissions", 
			name = "transmission",
			buttons = { 
				{name = "Stock Transmission",mod = -1,modtype =13, costs = 400, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Transmission",mod = false,modtype =13, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sports Transmission",mod = 1,modtype =13, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Race Transmission",mod = 2,modtype =13, costs = 40000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		}
		,
		["turbo"] = { 
			...
			buttons = { 
				...
				{name = "Turbo Tuning",mod = true,modtype =18, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheels"] = { 
			title = "wheels", 
		...
		["sport"] = { 
			...
			name = "sport",
			buttons = { 
				{name = "Stock", wtype = false, modtype = 23, mod = -1, costs = 350, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Inferno", wtype = false, modtype = 23, mod = false, costs = 120, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Deepfive", wtype = false, modtype = 23, mod = 1, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lozspeed", wtype = false, modtype = 23, mod = 2, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Diamondcut", wtype = false, modtype = 23, mod = 3, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Chrono", wtype = false, modtype = 23, mod = 4, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Feroccirr", wtype = false, modtype = 23, mod = 5, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Fiftynine", wtype = false, modtype = 23, mod = 6, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Mercie", wtype = false, modtype = 23, mod = 7, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Syntheticz", wtype = false, modtype = 23, mod = 8, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Organictyped", wtype = false, modtype = 23, mod = 9, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Endov1", wtype = false, modtype = 23, mod = 10, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Duper7", wtype = false, modtype = 23, mod = 11, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Uzer", wtype = false, modtype = 23, mod = 12, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Groundride", wtype = false, modtype = 23, mod = 13, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Spacer", wtype = false, modtype = 23, mod = 14, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Venum", wtype = false, modtype = 23, mod = 15, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Cosmo", wtype = false, modtype = 23, mod = 16, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Dashvip", wtype = false, modtype = 23, mod = 17, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Icekid", wtype = false, modtype = 23, mod = 18, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Ruffeld", wtype = false, modtype = 23, mod = 19, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Wangenmaster", wtype = false, modtype = 23, mod = 20, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Superfive", wtype = false, modtype = 23, mod = 21, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Endov2", wtype = false, modtype = 23, mod = 22, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Slitsix", wtype = false, modtype = 23, mod = 23, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["suv"] = { 
			title = "suv", 
			name = "suv",
			buttons = { 
				{name = "Stock", wtype = 3, modtype = 23, mod = -1, costs = 350, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vip", wtype = 3, modtype = 23, mod = false, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Benefactor", wtype = 3, modtype = 23, mod = 1, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Cosmo", wtype = 3, modtype = 23, mod = 2, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bippu", wtype = 3, modtype = 23, mod = 3, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Royalsix", wtype = 3, modtype = 23, mod = 4, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Fagorme", wtype = 3, modtype = 23, mod = 5, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Deluxe", wtype = 3, modtype = 23, mod = 6, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Icedout", wtype = 3, modtype = 23, mod = 7, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Cognscenti", wtype = 3, modtype = 23, mod = 8, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lozspeedten", wtype = 3, modtype = 23, mod = 9, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Supernova", wtype = 3, modtype = 23, mod = 10, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Obeyrs", wtype = 3, modtype = 23, mod = 11, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lozspeedballer", wtype = 3, modtype = 23, mod = 12, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Extra vaganzo", wtype = 3, modtype = 23, mod = 13, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Splitsix", wtype = 3, modtype = 23, mod = 14, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Empowered", wtype = 3, modtype = 23, mod = 15, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sunrise", wtype = 3, modtype = 23, mod = 16, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Dashvip", wtype = 3, modtype = 23, mod = 17, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Cutter", wtype = 3, modtype = 23, mod = 18, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["offroad"] = { 
			title = "offroad", 
	...
	["armor"] = { 
		...
		name = "armor",
		buttons = { 
			{name = "None",modtype = 16, mod = -1,costs = 500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 20%",modtype = 16, mod = false, costs = 15500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 40%",modtype = 16, mod = 1, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 60%",modtype = 16, mod = 2, costs = 29000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 80%",modtype = 16, mod = 3, costs = 38000, description = "", centre = 0, font = 0, scale = 0.4},
	...
	["brakes"] = { 
		...
		name = "brakes",
		buttons = { 
			{name = "Stock Brakes",modtype = 12, mod = -1, costs = 400, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Street Brakes",modtype = 12, mod = false, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Race Brakes",modtype = 12, mod = 2, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["engine"] = { 
		...
		buttons = { 
			...
			{name = "EMS Upgrade, Level 2",modtype = 11, mod = false, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 20000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 4",modtype = 11, mod = 2, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = { 
			title = "horns", 
...
function DriveInGarage()
		...
		if DoesEntityExist(veh) then
			...
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["frontbumper"].buttons , {name = "None",modtype = mod,costs = 400,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["rearbumper"].buttons, {name = "None",modtype = mod,costs = 1600,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["rearbumper"].buttons, {name = name,modtype = mod,costs =400,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["exhaust"].buttons, {name = "None",modtype = mod,costs = 750,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["exhaust"].buttons, {name = name,modtype = mod,costs = 200,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
							Citizen.Trace(name.." "..mod.." "..mod)
						end
					end
				end		
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["fenders"].buttons, {name = "None",modtype = mod,costs = 800,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["hood"].buttons, {name = "None",modtype = mod,costs = 800,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["hood"].buttons, {name = name,modtype = mod,costs = 200,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
							Citizen.Trace(name.." "..mod.." "..mod)
						end
					end
				end	
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["rollcage"].buttons, {name = "None",modtype = mod,costs = 650,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["rollcage"].buttons, {name = name,modtype = mod,costs = 300,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["roof"].buttons, {name = "None",modtype = mod,costs = 600,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["roof"].buttons, {name = name,modtype = mod,costs = 100,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["skirts"].buttons, {name = "None",modtype = mod,costs = 800,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["skirts"].buttons, {name = name,modtype = mod,costs = 800,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["spoiler"].buttons, {name = "None",modtype = mod,costs = 900,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["spoiler"].buttons, {name = name,modtype = mod,costs = 900,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["grille"].buttons, {name = "None",modtype = mod,costs = 450,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					if lbl ~= nil then
						local name = tostring(GetLabelText(lbl))
						if name ~= "NULL" then
							insrt(lsc.menu["grille"].buttons, {name = name,modtype = mod,costs = 450,mod = i, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["chassis"].buttons, {name = "None",modtype = mod,costs = 2000,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					...
					for i,pos in ipairs(lsc.locations) do
						...
						if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
							if pos.locked == false then
								lsc_drawTxt("appuyez sur ~b~X~w~ pour entrer chez ~b~Los Santos Customs ",4,1,0.5,0.8,1.0,255,255,255,255)
								...
								lsc_drawTxt("~r~Occupé, veuillez patientez...",4,1,0.5,0.8,1.0,255,255,255,255)
							end
						end
					end
				end
...
function AddBlips()
	for i,pos in ipairs(lsc.locations) do
       ...
       if not info then		
			RequestStreamedTextureDict("shopui_title_carmod",1)
			while not HasStreamedTextureDictLoaded("shopui_title_carmod")  do
				Wait(1)
			end
			
			exports['blip_info']:SetBlipInfoImage(blip,"shopui_title_carmod","shopui_title_carmod")  
			exports['blip_info']:SetBlipInfoTitle(blip, "~r~Los Santos customs", false)
            exports['blip_info']:AddBlipInfoText(blip, "Atelier automobile", "")
            exports['blip_info']:AddBlipInfoName(blip, "~p~Réparations & Mods haut de gamme.", "")
		    info = true
		end
...
function UpdateVehicle(car)
	Citizen.CreateThread(function()
		...
		if DoesEntityExist(veh) then
			...
			vRP.notify({"Pas de vehicule trouvé!"})
		end
	end)
end
